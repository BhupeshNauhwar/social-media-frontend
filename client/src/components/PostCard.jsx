...
import Loading from '../components/TextInput';
        ...
        return(
            <div className='w-full py-3'>
                <div className='flex gap-3 items-center mb-1'>
                    ...
                    <div>
                        <Link to={"/profile/" +reply?.userId?._id}>
                        <p className='font-medium text-base text-ascent-2'>
                               ...
                               comments.map((comment)=>(
                                <div className='w-full py-2' key={comment?._id}>
                                    ...
                                    <div>
                                        ...
                                        <span className='text-ascent-2 text-sm '>{moment(comment?.createdAt ?? "2024-07-14").fromNow()}
                                    ...
                                    <div className='py-2 px-8 mt-6'>
                                            ...
                                            )}
                                            {
                                                ...
                                                comment?.replies?.map((reply)=>(<ReplyCard reply={reply} user={user} key={reply?._id}
                                    ...
                                    <span className='flex text-sm py-4 text-ascent-2 text-center'>
                                        No Comments ,be first to comments
                                    </span>
                                )
                            )
                        }
