                ...
                &#8203;
                    ...
                    aria-labelledby='modal-headline'>
                        ...
                        onSubmit={handleSubmit(onSubmit)}>
                            ...
                            error={errors.firstName ? errors.location?.message : "" }
                            />
                            <TextInput 
                            label='Last Name'
                            ...
                            type='text'
                            styles='w-full'
                            register={register("lastName",{required:" Last Name required"

                            })}
                            error={errors.lastName ? errors.location?.message : "" }
                            />
                            <TextInput 
                            label='Profession'
                            ...
                            type='text'
                            styles='w-full'
                            register={register("profession",{required:" Profession required"

                            })}
                            error={errors.profession ? errors.location?.message : "" }
                            />
                            <TextInput 
                            label='Location'
                            ...
                            />
                            <label className='flex items-centergap-1 text-base text-ascent-2 hover:text-ascent-1 cursor-pointer my-4' htmlFor="imgUpload">
                                <input type="file"
                                className=''
                                id='imgUpload'
